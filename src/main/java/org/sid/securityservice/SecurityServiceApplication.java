...
public class SecurityServiceApplication {
    ...
    CommandLineRunner start(AccountService accountService)
    {
        ...
        accountService.addNewRole(new AppRole(null,"CUSTOMERS-MANAGER"));
        accountService.addNewRole(new AppRole(null,"PRODUCTS-MANAGER"));
        ...
        //affect roles to users
            ...
            accountService.addRoleToUser("user2","CUSTOMERS-MANAGER");

            accountService.addRoleToUser("user3","USER");
            accountService.addRoleToUser("user3","PRODUCTS-MANAGER");
